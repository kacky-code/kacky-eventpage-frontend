      ...
      <Center pt={2}>
        <div style={{textAlign: "left", width: "66%", lineHeight: "2", fontSize: "larger", textTransform: "none"}} >
          ...
          >
            ...
            <Text fontSize="xl" fontWeight="400" textDecoration="underline" textUnderlineOffset="0.2em">General Setup</Text>
            ...
            <p>Either you use Nightbot&#39;s graphical interface and add the <Code>$(urlfetch)</Code> part in
              the &quot;Message&quot; field or you use the <Code>!addcom</Code> command in chat. <strong>Please set a cooldown! </strong>
              Dont ddos my poor server from your chat. 1s should be fine, that prevents multiple
              queries at once.</p>
          ...
          >
            ...
            <p style={{ marginTop: 15 }}>Depending on the argument you provide to <Code>strings</Code> you either get a list of all KackyID&#39;s
            ...
            <List>
              <ListItem>
                <Code>https://api.kacky.gg/event/*tmlogin*/finned?string=ids</Code>
              </ListItem>
              <ListItem>
                <Code>https://api.kacky.gg/event/*tmlogin*/finned?string=scores</Code>
              </ListItem>
              <ListItem>
                <Code>https://api.kacky.gg/event/*tmlogin*/finned?string=ranks</Code>
              </ListItem>
            </List>
            ...
            >
              <ExpandBox
                content={
                  <pre>
                    <Code>
                      !addcom !finned -cd=1 *YourNameHere* finished these maps: $(urlfetch https://api.kacky.gg/event/*tmlogin*/finned?string=ids)
                    </Code>
                  </pre>
                }
              ...
              <ExpandBox
                ...
                content={<WebHowTo command="!finned" message="*YourNameHere* finished these maps: $(urlfetch https://api.kacky.gg/event/*tmlogin*/finned?string=ids)" />}
              />
            </VStack>
          </Flex>
          ...
          >
            ...
            <p style={{ marginTop: 15 }}>List of maps that are not yet finished by the provided login.</p>
            <Text fontSize="m" fontWeight="400" textDecoration="underline" textUnderlineOffset="0.2em" pt={5}>Query Endpoints:</Text>
            <List>
              <ListItem>
                <Code>https://api.kacky.gg/event/*tmlogin*/unfinned?string=1</Code>
              </ListItem>
            </List>
            <Text fontSize="m" fontWeight="400" textDecoration="underline" textUnderlineOffset="0.2em" pt={5}>Return Value:</Text>
            ...
            >
              <ExpandBox
                content={
                  <pre>
                    <Code>
                      !addcom !unfinned -cd=1 *YourNameHere* is missing these maps: $(urlfetch https://api.kacky.gg/event/*tmlogin*/unfinned?string=1)
                    </Code>
                  </pre>
                }
              ...
              <ExpandBox
                title="How to create Command in Nightbot Webinterface?"
                content={<WebHowTo command="!unfinned" message="*YourNameHere* is missing these maps: $(urlfetch https://api.kacky.gg/event/*tmlogin*/unfinned?string=1)" />}
              />
            </VStack>
          </Flex>
          ...
          >
            ...
            <p style={{ marginTop: 15 }}>Searches for the unfinished map of <Code>tmlogin</Code> which is played next and returns when it is
              played. <Code>simochat</Code> is a dumb parameter name, might (should definitely) change before KR4.<br/>
              Currently this returns a whole sentence, because it seemed easiest, as it also handles multple maps&nbsp;
              being played at the same time.
            </p>
            <Text fontSize="m" fontWeight="400" textDecoration="underline" textUnderlineOffset="0.2em" pt={5}>Query Endpoints:</Text>
            <List>
              <ListItem>
                <Code>https://api.kacky.gg/event/*tmlogin*/nextunfinned?simochat=1</Code>
              </ListItem>
            </List>
            <Text fontSize="m" fontWeight="400" textDecoration="underline" textUnderlineOffset="0.2em" pt={5}>Return Value:</Text>
            ...
            >
              ...
              <ExpandBox
                title="How to create Command in Nightbot Webinterface?"
                content={<WebHowTo command="!nextunfinned" message="Next unfinished map in $(urlfetch https://api.kacky.gg/event/*tmlogin*/nextunfinned?simochat=1)" />}
              />
            </VStack>
          </Flex>
          ...
          >
            ...
            <p>The api is public. This means, if you want to query stats for other players by doing
              commands like <Code>!finned tmlogin</Code>, feel free to do so. You then have to replace <Code>*tmlogin*</Code> in the
          ...
          >
            <Text fontSize="2xl" fontWeight="400" textDecoration="underline" textUnderlineOffset="0.2em" pt={5}>Hidden Dashboards</Text>
              <HStack>
                ...
                <Center w="50%">
                  <Image w={314} src="https://static.kacky.gg/misc/glance_example.jpg"/>
                </Center>
            </HStack>
          </Flex>
        </div>
